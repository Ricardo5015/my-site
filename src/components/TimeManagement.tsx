...
const TimeManagementCalendar = () => {
  ...
  const [draggedCardType, setDraggedCardType] = useState<'work' | 'rest' | null>(null);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">拖拽卡片来规划你的努力生活 🎴</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl p-4 border border-blue-400/30">
            <div className="text-blue-300 text-sm mb-1">努力卡片</div>
          ...
          <div className="bg-gradient-to-br from-pink-500/20 to-rose-500/20 backdrop-blur-lg rounded-xl p-4 border border-pink-400/30">
            <div className="text-pink-300 text-sm mb-1">摆烂卡片</div>
          ...
          <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl p-4 border border-green-400/30">
            <div className="text-green-300 text-sm mb-1">努力天数</div>
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl p-4 border border-purple-400/30">
            <div className="text-purple-300 text-sm mb-1">完成率</div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
                  ...
                  >
                    ...
                    `}>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {isUsed && <span className="text-[10px] bg-black/30 px-2 py-0.5 rounded">已用</span>}
                      </div>
            ...
            {usedWorkCardIds.length > 0 && (
              <div className="mt-4 pt-4 border-t border-white/10">
                <div className="text-white text-sm mb-2">已使用：</div>
                  ...
                  >
                    ...
                    `}>
                      ...
                      <div className="text-center space-y-2">
                        ...
                        <div className="text-white text-xs font-medium">连续摆烂 2 天</div>
                      </div>
        ...
        <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 backdrop-blur-lg rounded-xl p-4 border border-yellow-500/30">
          ...
          <ul className="text-yellow-200 text-sm space-y-1">
            <li>• 🎴 <strong>努力生活卡</strong>：拖拽到日历，占据连续3天，每天一个主题</li>
            <li>• 😴 <strong>无敌摆烂卡</strong>：拖拽到日历，占据连续2天，安心休息</li>
            <li>• 🗑️ 点击下方"已使用"区域的卡片编号可以移除</li>
            <li>• 📊 建议配置：7张努力卡(21天) + 3张摆烂卡(6天) = 约60%努力率</li>
            <li>• ✨ 记住：三天打鱼两天晒网，也是一种坚持！</li>
          </ul>
        </div>
